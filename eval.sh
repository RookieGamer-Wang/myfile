...
CHECKPOINT_PATH=/home/Megatron-DeepSpeed/examples/MoE/output/checkpoint/gpt-0.35B-lr-1.2e-4-minlr-1.0e-6-bs-256-gpus-8-mp-1-pp-1-ep-32-mlc-0.01-cap-1.0-drop-true/global_step30/
CONFIG_PATH=/home/Megatron-DeepSpeed/examples/MoE/ds_config_gpt_gpt-0.35B-lr-1.2e-4-minlr-1.0e-6-bs-256-gpus-64-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true.json
RESULT_PATH=gpt_gpt-0.35B-lr-1.2e-4-minlr-1.0e-6-bs-256-gpus-64-mp-1-pp-1-ep-128-mlc-0.01-cap-1.0-drop-true.log
...
VOCAB_FILE=/home/data/Megatron-LM/the_pile_public_merged_nopreprocessing/gpt2-vocab.json
MERGE_FILE=/home/data/Megatron-LM/the_pile_public_merged_nopreprocessing/gpt2-merges.txt
