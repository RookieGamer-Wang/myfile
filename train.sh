...
if [ "${USE_INTERNAL_DATA}" = "true" ]; then
    ...
    BASE_DATA_PATH=/home/data/Megatron-LM/the_pile_public_merged_nopreprocessing
    DATA_HOME=/home/data/Megatron-LM/data
    ...
    BC2="${DATA_HOME}/BookCorpusDataset_text_document"
